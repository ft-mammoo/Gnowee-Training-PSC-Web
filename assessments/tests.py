...
class AssignmentTest(TestCase):
    ...
    def test_listing(self):
        ...
        _ = models.Assignment.objects.create(
            course=c2,
            teacher=t2,
            title="Sociology Basics",
            description="Basic concepts of Sociology.",
...
class SubmissionTest(TestCase):
    ...
    def test_listing(self):
        ...
        _ = models.Submission.objects.create(
            student=s3,
            assignment=a3,
            submitted_date="2023-09-30",
        )
...
class SubmissionGradeTest(TestCase):
    ...
    def test_list(self):
        ...
        _ = models.SubmissionGrade.objects.create(
            submission=sb2,
            grade=90,
            graded_by=t2,
            feedback="Good job!",
...
class QuestionCategoriesTest(TestCase):
    ...
    def test_serializer(self):
        se = serializer.QuestionCategorySerializer(self.qc1)
        print(se.data)
    ...
    def test_create(self):
        ...
        se = serializer.QuestionCategorySerializer(data=data)
        self.assertTrue(se.is_valid(), se.errors)
        qc = se.save()
    ...
    def test_update(self):
        ...
        se = serializer.QuestionCategorySerializer(self.qc1, data=change, partial=True)
        self.assertTrue(se.is_valid(), se.errors)
        qc = se.save()
    ...
    def test_listing(self):
        _ = models.QuestionCategories.objects.create(
            name="Physics",
            description="Questions related to Physics.",
        )
        _ = models.QuestionCategories.objects.create(
        ...
        with CaptureQueriesContext(connection=connection) as ctx:
            se = serializer.QuestionCategorySerializer(qs, many=True)
            print(se.data)
        print(ctx.captured_queries)
        self.assertLessEqual(len(ctx.captured_queries), 1)
...
class ExamsQuestionsTest(TestCase):
    ...
    def test_serializer(self):
        se = serializer.ExamQuestionSerializer(self.eq1)
        print(se.data)
    ...
    def test_create(self):
        ...
        se = serializer.ExamQuestionSerializer(data=data)
        self.assertTrue(se.is_valid(), se.errors)
        se.save()
        print(se.data)
    ...
    def test_update(self):
        ...
        se = serializer.ExamQuestionSerializer(self.eq1, data=change, partial=True)
        self.assertTrue(se.is_valid(), se.errors)
        se.save()
        print(se.data)
    ...
    def test_listing(self):
        ...
        _ = models.ExamQuestions.objects.create(
            category=qc2,
            question_text="What is the boiling point of water?",
            question_type="s",
            marks=3,
        ...
        # views.py should be optimized to avoid N+1 queries,
        # so we use select_related and prefetch_related here to test that
        qs = models.ExamQuestions.objects.select_related("category").prefetch_related("options").all()
        with CaptureQueriesContext(connection=connection) as ctx:
            se = serializer.ExamQuestionSerializer(qs, many=True)
            print(se.data)
        print(ctx.captured_queries)
...
class QuestionOptionsTest(TestCase):
    ...
    def test_listing(self):
        ...
        _ = models.QuestionOptions.objects.create(
            question=q2,
            option_code="A",
            option_text="8",
            is_correct=True,
...
class ExamQuestionsMappingTest(TestCase):
    ...
    def test_listing(self):
        ...
        _ = models.ExamQuestionsMapping.objects.create(
            exam=ex2,
            question=eq2,
        )
...
class ExamAnswersTest(TestCase):
    def setUp(self):
        self.c1 = Course.objects.create(
            title="Mathematics",
            description="Mathematics course",
    ...
    def test_serializer(self):
        se = serializer.ExamAnswersSerializer(self.ea1)
        print(se.data)
        self.assertEqual(se.data["answer_text"], "4")
    ...
    def test_listing(self):
        ...
        es2 = models.ExamSubmissions.objects.create(
            student=s2,
            exam=ex2,
        )
        qc2 = models.QuestionCategories.objects.create(
        ...
        _ = models.ExamAnswers.objects.create(
            exam_submission=es2,
            question=q2,
            answer_text="4",
        )
        qs = models.ExamAnswers.objects.all()
        with CaptureQueriesContext(connection=connection) as ctx:
            se = serializer.ExamAnswersSerializer(qs, many=True)
            print(se.data)
        print(ctx.captured_queries)
        self.assertEqual(len(se.data), 2)
